    ...
    <div className="max-w-xl mx-auto my-8">
      <div className="glass-panel p-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 text-white font-medium py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-3 text-sm shadow-sm mb-6"
        >
        ...
        <div className="relative my-6 text-center">
          ...
          <span className="relative px-3 bg-slate-950 text-[11px] font-semibold tracking-wider text-slate-500 uppercase">
